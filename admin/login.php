...
<body class="hold-transition ">
  ...
  <style>
    ...
    body{
      background-image: url("./user/imgdex.jpg");   /**      back img */
  ...
  <!-- this is login image section and heading -->
  ...
  <div class="h-100 d-flex align-items-center w-100" id="login">
    ...
    <div class="w-100">
    <center>
        <img src="./user/hm.jpeg" alt="" id="logo-img">
    </center>
    <h1 class="text-center py-5 login-title"><b>Hamdard Student Point</b></h1>    
</div>
